...
Adapted from the SENTINEL starter kit (Apache-2.0). Requests ignore unknown fields so the service keeps
working when organizers add context; responses are strict because the evaluator rejects anything that does
